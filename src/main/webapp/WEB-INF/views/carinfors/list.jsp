            ...
            <div class="col-md-8">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" name="search">
                            ...
                            <option value="CAR_NAME"  <%= (searchStr.equals("CAR_NAME"))? "selected" : "" %>>selected>CAR_NAME</option>
                          
                          </select>

                    <input type="text" name="words" vlaue='<%= params.getOrDefault("words", "") %>' class="form-control" placeholder="Search..." id="keydownEnter">
